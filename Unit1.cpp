...
void __fastcall TForm1::pole1Click(TObject *Sender)
{
        if(p1=='n')
        {
                ...
                pole1->Enabled=false;
                 ...
                 else  {pole1->Picture->LoadFromFile("img/x.bmp");
                p1='x';
                kto='o';
                tura->Picture->LoadFromFile("img/osmall.bmp");
                pole1->Enabled=false;}
    ...
    if(p2=='n')
        {
                ...
                pole2->Enabled=false;
                 ...
                 else  {pole2->Picture->LoadFromFile("img/x.bmp");
                p2='x';
                kto='o';
                tura->Picture->LoadFromFile("img/osmall.bmp");
                pole2->Enabled=false;}
     ...
     if(p3=='n')
        {
                ...
                pole3->Enabled=false;
                 ...
                 else  {pole3->Picture->LoadFromFile("img/x.bmp");
                p3='x';
                kto='o';
                tura->Picture->LoadFromFile("img/osmall.bmp");
                pole3->Enabled=false;}
 ...
 if(p4=='n')
        {
                ...
                pole4->Enabled=false;
                 ...
                 else  {pole4->Picture->LoadFromFile("img/x.bmp");
                p4='x';
                kto='o';
                tura->Picture->LoadFromFile("img/osmall.bmp");
                pole4->Enabled=false;}
 ...
 if(p5=='n')
        {
                ...
                pole5->Enabled=false;
                 ...
                 else  {pole5->Picture->LoadFromFile("img/x.bmp");
                p5='x';
                kto='o';
                tura->Picture->LoadFromFile("img/osmall.bmp");
                pole5->Enabled=false;}
 ...
 if(p6=='n')
        {
                ...
                pole6->Enabled=false;
                 ...
                 else  {pole6->Picture->LoadFromFile("img/x.bmp");
                p6='x';
                kto='o';
                tura->Picture->LoadFromFile("img/osmall.bmp");
                pole6->Enabled=false;}
 ...
 if(p7=='n')
        {
                ...
                pole7->Enabled=false;
                 ...
                 else  {pole7->Picture->LoadFromFile("img/x.bmp");
                p7='x';
                kto='o';
                tura->Picture->LoadFromFile("img/osmall.bmp");
                pole7->Enabled=false;}
 ...
 if(p8=='n')
        {
                ...
                pole8->Enabled=false;
                 ...
                 else  {pole8->Picture->LoadFromFile("img/x.bmp");
                p8='x';
                kto='o';
                tura->Picture->LoadFromFile("img/osmall.bmp");
                pole8->Enabled=false;}
 ...
 if(p9=='n')
        {
                ...
                pole9->Enabled=false;
                 ...
                 else  {pole9->Picture->LoadFromFile("img/x.bmp");
                p9='x';
                kto='o';
                tura->Picture->LoadFromFile("img/osmall.bmp");
                pole9->Enabled=false;}
